...
function currencySelectItemToggler(e) {
  item = $(e);
  $(".modal-currency__current").toggleClass("modal-lang__select__active");
  $(".modal-currency__select").toggleClass("modal-currency__select__active");
  $(".modal-currency__current").children("span").html(item.text());
}
...
function modalLangItemToggler(e) {
  $(".modal-lang-list").toggleClass("modal-lang-list__active");
  item = $(e);
  $(".modal-lang__current").children("span").html(item.text());
}
...
$(".citizenship__select__wrapper").click(function () {
  $(".tourists-price__arrow").toggleClass("main-arrow__active");
  $(".citizenship-select___options").toggleClass(
    "citizenship-select___options__active"
  );
});

$(".citizenship-option").click(function () {
  $(".tourists-price__arrow").toggleClass("main-arrow__active");
  $(".citizenship-select___options").toggleClass(
    "citizenship-select___options__active"
  );

  $(".citizenship_pricetype__value").html($(this).html());
});
...
function chessActiveAfter() {
  items = document.querySelectorAll(".placechess-room__info_active");
  items.forEach((item) => {
    if (
      item.nextElementSibling !== null &&
      item.nextElementSibling.classList.contains("placechess-room__info_active")
    ) {
...
function menuFix() {
  let nav = $("header");
  let navInner = $("header").html();
  let parentMargin = nav.parent().next().css("margin");

  if ($(window).width() > "990") {
    $(window).scroll(function () {
      if ($(this).scrollTop() > 20) {
        nav.addClass("header-fixed");
        nav.parent().next().css("margin-top", "16.5rem");
        $(".guide").css("margin-top", "5rem");
        $(".main").css("padding-top", "8rem");
        $("header").html(headerBlue);
      } else {
        nav.removeClass("header-fixed");
        nav.parent().next().css("margin-top", "0rem");
        $(".guide").css("margin-top", "13rem");
        $(".main").css("padding-top", "0rem");
        $("header").html(navInner);
      }
    });
  }
}
    ...
    if (
      ...
      list.removeClass(function (i, cls) {
        cls.split(" ").forEach((item) => {
          item.includes("__active") ? $("." + item).removeClass(item) : null;
        });
        $(cls).removeClass(cls);
      });
    }
...
let headerBlue = `
        <nav>
          ...
          <div class="nav-menu nav-menu__blue ">
            <div class="nav-search">
              <a href="#">
                ...
                <svg
                  class="cu-p desk-icon svg__blue"
                  viewBox="0 0 45 55"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <div class="nav-booking nav-booking__blue cu-p" onclick="navBookingClick()">
              <div class="mobile-nav mobile-booking">
                <svg
                  class="mob-icon mob-icon__active"
                  viewBox="0 0 18 19"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <div class="nav-lang nav-lang__blue nav-desktop cu-p">
              <div class="nav-lang__wrapper" onclick="navLangClick()">
                <span class="text-main bold">RU</span>
                <svg
              ...
              <div class="modal-lang__options header__modal-lang__options">
                <div class="modal-options__lang">
                  ...
                  onclick="langListToggler()">
                    <span class="text-main bold">Русский</span>
                    <svg
                  ...
                  <div class="modal-lang-list">
                    <div class="modal-lang-item" onclick="modalLangItemToggler(this)">
                      <span class="text-gray">Белорусский</span>
                    </div>
                    <div class="modal-lang-item modal-lang-item__active" onclick="modalLangItemToggler(this)">
                      <span class="text-gray">Русский</span>
                    </div>
                    <div class="modal-lang-item text-gray" onclick="modalLangItemToggler(this)">
                ...
                <div class="modal-options__currency">
                  ...
                  <div class="modal-lang__select modal-currency__current" onclick="modalCurrencyToggler()">
                    <span class="text-main bold">BYN</span>
                    <svg
                      class="cu-p modal-arrow main-arrow"
                      viewBox="0 0 15 15"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div class="modal-currency__select">
                    <span
                      class="text-gray modal-currency__select__item modal-currency__select__item__active" onclick="currencySelectItemToggler(this)"
                      >BYN</span
                    ><span class="text-gray modal-currency__select__item" onclick="currencySelectItemToggler(this)"
                      >RUB</span
                    ><span class="text-gray modal-currency__select__item" onclick="currencySelectItemToggler(this)"
                      >EUR</span
                    >
            ...
            <div class="nav-auth nav-auth__blue">
          ...
          <div class="header-burger cu-p" onclick="rightModalToggler()">
            <div class="header-burger__block header-burger__block__blue"></div>
          </div>
        </nav>
`;
